...
book_info = [
    {'title': 'Python for Everyone', 'author': 'China', 'category': 'Coding', 'image_path': 'UI/Images/books/book.webp'},
    {'title': 'Python for Everyone', 'author': 'China', 'category': 'Coding', 'image_path': 'UI/Images/books/book.webp'},
    {'title': 'Python for Everyone', 'author': 'China', 'category': 'Coding', 'image_path': 'UI/Images/books/book.webp'},
    {'title': 'Python for Everyone', 'author': 'China', 'category': 'Coding', 'image_path': 'UI/Images/books/book.webp'},
    {'title': 'Python for Everyone', 'author': 'China', 'category': 'Coding', 'image_path': 'UI/Images/books/book.webp'},
    ...
    {'title': 'Python for Everyone', 'author': 'China', 'category': 'Coding', 'image_path': 'UI/Images/books/book.webp'},
    {'title': 'Python for Everyone', 'author': 'China', 'category': 'Coding', 'image_path': 'UI/Images/books/book.webp'},
    {'title': 'mohamed for Everyone', 'author': 'China', 'category': 'Coding', 'image_path': 'UI/Images/books/book.webp'},
]
...
class MainPage(tk.CTk):
  ...
  def main_header(self):
    ...
    self.iconImg=tk.CTkImage(Image.open("UI/Images/searchIcon.png"),size=(20,20))
